#pragma checksum "C:\Users\geri\source\repos\New folder\restaurant\Views\Home\Privacy.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "03f56401a2db9b712bb16bd554ad719a16155cd6"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"03f56401a2db9b712bb16bd554ad719a16155cd6", @"/Views/Home/Privacy.cshtml")]
...
<p>We respect your privacy and are committed to protecting it through our compliance with this privacy policy (“Policy”). This Policy describes the types of information we may collect from you or that you may provide (“Personal Information”) on our website and any of its related products and services (collectively, “Services”), and our practices for collecting, using, maintaining, protecting, and disclosing that Personal Information. It also describes the choices available to you regarding our use of your Personal Information and how you can access and update it.</p>
<p>This Policy is a legally binding agreement between you (“User”, “you” or “your”) and this Website operator (“Operator”, “we”, “us” or “our”). If you are entering into this agreement on behalf of a business or other legal entity, you represent that you have the authority to bind such entity to this agreement, in which case the terms “User”, “you” or “your” shall refer to such entity. If you do not have such authority");
            WriteLiteral(@", or if you do not agree with the terms of this agreement, you must not accept this agreement and may not access and use the Website and Services. By accessing and using the Website and Services, you acknowledge that you have read, understood, and agree to be bound by the terms of this Policy. This Policy does not apply to the practices of companies that we do not own or control, or to individuals that we do not employ or manage.</p>
<div class=""wpembed-index""><h3>Table of contents</h3><ol class=""wpembed-index""><li><a href=""#collection-of-personal-information"">Collection of personal information</a></li><li><a href=""#privacy-of-children"">Privacy of children</a></li><li><a href=""#use-and-processing-of-collected-information"">Use and processing of collected information</a></li><li><a href=""#managing-information"">Managing information</a></li><li><a href=""#disclosure-of-information"">Disclosure of information</a></li><li><a href=""#retention-of-information"">Retention of information</a></li><li><a href=""#do-not-track");
            WriteLiteral(@"-signals"">Do Not Track signals</a></li><li><a href=""#social-media-features"">Social media features</a></li><li><a href=""#links-to-other-resources"">Links to other resources</a></li><li><a href=""#information-security"">Information security</a></li><li><a href=""#data-breach"">Data breach</a></li><li><a href=""#changes-and-amendments"">Changes and amendments</a></li><li><a href=""#acceptance-of-this-policy"">Acceptance of this policy</a></li><li><a href=""#contacting-us"">Contacting us</a></li></ol></div>
...
<p>We receive and store any information you knowingly provide to us when");
            WriteLiteral(@" you create an account, publish content,  or fill any forms on the Website. When required, this information may include the following:</p>
<ul>
...
<p>We do not knowingly collect any Personal Information from children under the age of 13. If you are under the age of 13, please do not submit any Personal Information through the Website and Services. If you have reason to believe that a child under the age of 13 has provided Personal Information to us through the Website and Services, please contact us to request that we delete that child’s Personal Infor");
            WriteLiteral(@"mation from our Services.</p>
...
<p> Our role may also differ depending on the specific situation involving Personal Information. We act in the capacity of a data controller when we ask you to subm");
            WriteLiteral(@"it your Personal Information that is necessary to ensure your access and use of the Website and Services. In such instances, we are a data controller because we determine the purposes and means of the processing of Personal Information.</p>
...
<ul>
    <li>Cre");
            WriteLiteral(@"ate and manage user accounts</li>
...
<p> Note that under some legislations we may be allowed to process information until you object to such processing by opting out, without having to rely on consent or any other of the legal bases. In any ca");
            WriteLiteral(@"se, we will be happy to clarify the specific legal basis that applies to the processing, and in particular whether the provision of Personal Information is a statutory or contractual requirement, or a requirement necessary to enter into a contract.</p>
...
<p> Depending on the requested Services or as necessary to complete any transaction or provide any Service you have requested, we may share your information with our affiliates, contracted companies, and service providers (collec");
            WriteLiteral(@"tively, “Service Providers”) we rely upon to assist in the operation of the Website and Services available to you and whose privacy policies are consistent with ours or who agree to abide by our policies with respect to Personal Information. We will not share any personally identifiable information with third parties and will not share any information with unaffiliated third parties.</p>
...
<p>We will retain and use your Personal Information for the period necessary to comply with our legal obligations, to enforce our agreements, resolve disputes, and unl");
            WriteLiteral(@"ess a longer retention period is required or permitted by law.</p>
...
<p>Some browsers incorporate a Do Not Track feature that signals to websites you visit that you do not want to have your online activity tracked. Tracking is not the same as using or collecting information in connection with a website. For these purposes, tracking refers to collecting personally identifiable information from consumers who use or visit a website or online service as they move across different websites over time. How browsers communicate the D");
            WriteLiteral(@"o Not Track signal is not yet uniform. As a result, the Website and Services are not yet set up to interpret or respond to Do Not Track signals communicated by your browser. Even so, as described in more detail throughout this Policy, we limit our use and collection of your Personal Information.</p>
...
<p>The ");
            WriteLiteral(@"Website and Services contain links to other resources that are not owned or controlled by us. Please be aware that we are not responsible for the privacy practices of such other resources or third parties. We encourage you to be aware when you leave the Website and Services and to read the privacy statements of each and every resource that may collect Personal Information.</p>
...
<p>Therefore, while we strive to protect your Personal Information, you acknowledge that (i) there are security and privacy limitat");
            WriteLiteral(@"ions of the Internet which are beyond our control; (ii) the security, integrity, and privacy of any and all information and data exchanged between you and the Website and Services cannot be guaranteed; and (iii) any such information and data may be viewed or tampered with in transit by a third party, despite best efforts.</p>
...
<p>An updated version of this Policy will be effective immediately upon the posting of the revised Policy unless otherwise specified. Your continued use of the Website and Services after the effective date of the revised Policy (or such other act specified at that time) will constitute your consent to those changes. However, w");
            WriteLiteral(@"e will not, without your consent, use your Personal Information in a manner materially different than what was stated at the time your Personal Information was collected.</p>
...
<p><a href=""&#109;&#097;&#105;&#108;&#116;&#111;&#058;e&#109;ai&#108;&#64;a&#100;&#100;&#114;&#101;&#115;&#115;&#46;co&#109;"" target=""_blank"" rel=""nofollow"">e&#109;a&#105;l&#64;a&#100;&");
            WriteLiteral(@"#100;r&#101;&#115;&#115;&#46;&#99;om</a></p>
...
<p>This document was last updated on July 28, 2022</p>
");
        }
